import { c as createLucideIcon, u as useApp, r as reactExports, j as jsxRuntimeExports, m as motion, B as Button, b as ue, ar as Eye, P as Plus, A as AnimatePresence, V as Video, Z as Zap, as as Pause, h as Play, n as Sparkles } from "./index-BlWpIyR8.js";
...
import { C as ChartNoAxesColumn } from "./chart-no-axes-column-DeYNtfgO.js";
import { I as IndianRupee } from "./indian-rupee-CqzswLMW.js";
...
function AdsManagerTab() {
  ...
  const [clientCampaigns, setClientCampaigns] = reactExports.useState(CLIENT_CAMPAIGNS);
  const [showCreate, setShowCreate] = reactExports.useState(false);
  const [createStep, setCreateStep] = reactExports.useState(1);
  const [activeSection, setActiveSection] = reactExports.useState("own");
  ...
  const adTypeIcon = (type) => {
    if (type === "video") return /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { size: 11, className: "text-blue-400" });
    if (type === "app")
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { size: 11, className: "text-green-400" });
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 11, className: "text-purple-400" });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: [
      ...
      },
      {
        label: "Commission",
        value: "₹12.2K",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { size: 14, className: "text-green-400" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["own", "client"].map((sec) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        ...
        style: {
          background: activeSection === sec ? "linear-gradient(135deg, #2fa8ff, #a855f7)" : "rgba(255,255,255,0.06)",
          color: activeSection === sec ? "#fff" : "rgba(255,255,255,0.5)",
          border: activeSection === sec ? "none" : "1px solid rgba(255,255,255,0.08)"
        },
        children: sec === "own" ? "🎯 Apne Ads" : "🏢 Client Ads"
      },
      sec
    )) }),
    activeSection === "own" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showCreate && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 mb-2", children: STEP_LABELS.map((label, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: createStep > i + 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 12 }) : i + 1
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
            ...
            createStep === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[13px] font-semibold text-foreground flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { size: 13, className: "text-komo-blue" }),
                " Ad Type चुनें"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: [
                ...
                "button",
                {
                  ...
                  style: {
                    background: form.adType === opt.type ? "rgba(47,168,255,0.2)" : "rgba(255,255,255,0.04)",
                    border: `1px solid ${form.adType === opt.type ? "rgba(47,168,255,0.5)" : "rgba(255,255,255,0.08)"}`
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px]", children: opt.label.split(" ")[0] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-foreground", children: opt.label.split(" ").slice(1).join(" ") }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-komo-text-muted", children: opt.desc })
                  ]
                },
                opt.type
              )) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Video Views", children: "🎥 Video Views" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Traffic", children: "🌐 Traffic" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Sales", children: "💰 Sales (Commission)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "App Install", children: "📱 App Install" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Brand Awareness", children: "📣 Brand Awareness" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Engagement", children: "❤️ Engagement" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            createStep === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[13px] font-semibold text-foreground flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 13, className: "text-komo-purple" }),
                " Audience Target करें"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-komo-text-muted mb-2", children: "Age Range" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "select",
                    {
                      ...
                      children: ["13", "18", "21", "25", "30", "35", "40", "45"].map(
                        (a) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: a, children: a }, a)
                      )
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-komo-text-muted text-[13px]", children: "–" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "select",
                    {
                      className: "flex-1 bg-[#11161D] border border-white/10 rounded-xl px-3 py-2 text-[13px] text-foreground focus:outline-none focus:border-komo-blue",
                      ...
                      children: [
                        ...
                        "55",
                        "65+"
                      ].map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: a, children: a }, a))
                    }
                  )
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-komo-text-muted mb-2", children: "Location" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    className: "w-full bg-[#11161D] border border-white/10 rounded-xl px-3 py-2 text-[13px] text-foreground focus:outline-none focus:border-komo-blue",
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "India", children: "🇮🇳 India (All)" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Delhi", children: "Delhi NCR" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Mumbai", children: "Mumbai" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Bangalore", children: "Bangalore" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "UP-Bihar", children: "UP / Bihar" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "South", children: "South India" })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-komo-text-muted mb-2", children: [
                  "Interests चुनें (",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: INTERESTS.map((interest) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      background: selectedInterests.includes(interest) ? "rgba(47,168,255,0.25)" : "rgba(255,255,255,0.06)",
                      border: `1px solid ${selectedInterests.includes(interest) ? "rgba(47,168,255,0.5)" : "rgba(255,255,255,0.1)"}`,
                      color: selectedInterests.includes(interest) ? "#93c5fd" : "rgba(255,255,255,0.5)"
                    },
                    children: interest
                  },
                  interest
            ...
            createStep === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[13px] font-semibold text-foreground flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 13, className: "text-yellow-400" }),
                " Product Focus"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-yellow-300 font-semibold mb-1", children: "💡 Pro Tip" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-komo-text-muted", children: "Ek campaign mein sirf ek product focus karo — zyada conversion aata hai!" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              form.objective === "Sales (Commission)" || form.objective === "Sales" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-komo-text-muted mb-1", children: "Commission % (har sale pe)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[14px] font-bold text-green-400", children: "%" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-green-400 mt-1", children: [
                  "₹1000 sale pe = ₹",
                  (1e3 * Number(form.commissionRate || 0) / 100).toFixed(0),
                  " ",
                  "commission"
                ] })
              ] }) : null,
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { size: 14, className: "text-purple-400" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] font-semibold text-foreground", children: "A/B Test (Trial & Error)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-komo-text-muted", children: "2 versions test karo, best perform wala chuno" })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          background: abTesting ? "linear-gradient(90deg, #2fa8ff, #a855f7)" : "rgba(255,255,255,0.15)"
                        },
                        onClick: () => setAbTesting(!abTesting),
                        onKeyDown: (e) => e.key === "Enter" && setAbTesting(!abTesting),
              ...
              abTesting && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
            ...
            createStep === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[13px] font-semibold text-foreground flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { size: 13, className: "text-green-400" }),
                " ",
                "Budget Set करें"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: ["100", "250", "500", "1000", "2000", "5000"].map(
                (b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      background: form.budget === b ? "rgba(47,168,255,0.25)" : "rgba(255,255,255,0.06)",
                      border: `1px solid ${form.budget === b ? "rgba(47,168,255,0.5)" : "rgba(255,255,255,0.08)"}`,
                      color: form.budget === b ? "#93c5fd" : "rgba(255,255,255,0.6)"
                    },
                    children: [
                      "₹",
                      b
              ...
              form.budget && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "rounded-xl p-3",
                  style: {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-green-300 font-semibold", children: "📊 Estimated Results" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-komo-text-muted mt-1", children: [
                      "Daily spend: ₹",
                      Math.round(
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-komo-text-muted", children: [
                      ...
                      "–",
                      (Number(form.budget) * 150).toLocaleString(),
                      " people"
                    ] })
                  ]
                }
          ...
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-2", children: [
                {
                  label: "Reach",
                  value: c.reach >= 1e3 ? `${(c.reach / 1e3).toFixed(0)}K` : c.reach,
                ...
                {
                  label: "Commission",
                  value: `₹${(c.commissionEarned / 1e3).toFixed(1)}K`,
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { size: 11 })
                }
              ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] font-bold komo-gradient-text", children: stat.value }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-komo-text-muted", children: stat.label })
                  ]
                },
                stat.label
              )) })
    ...
    activeSection === "client" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-2xl p-4",
          style: {
            background: "linear-gradient(135deg, rgba(34,197,94,0.08), rgba(47,168,255,0.08))",
            border: "1px solid rgba(34,197,94,0.25)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[13px] font-semibold text-green-300 flex items-center gap-1.5 mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 13 }),
              " Client ke Ads chalakar Kamao"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-komo-text-muted", children: "Dusre businesses ke liye ads run karo aur monthly ₹5,000–₹50,000 charge karo" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          className: "w-full komo-gradient border-0 text-white h-10 text-[13px] font-semibold",
          onClick: () => ue.success("New client campaign form coming soon!"),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 15, className: "mr-2" }),
            " New Client Campaign"
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[13px] font-semibold text-komo-text-secondary flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 14, className: "text-komo-blue" }),
          " Active Client Campaigns"
        ] }),
        clientCampaigns.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 10 },
            animate: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-semibold text-foreground", children: c.client }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `text-[10px] font-bold px-1.5 py-0.5 rounded-full ${c.status === "active" ? "bg-green-500/15 text-green-400 border border-green-500/25" : "bg-yellow-500/15 text-yellow-400 border border-yellow-500/25"}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: [
                {
                  label: "Ad Budget",
                  value: `₹${(c.budget / 1e3).toFixed(0)}K`,
                  color: "text-blue-400"
                },
                {
                  label: "Monthly Charge",
                  value: `₹${(c.charge / 1e3).toFixed(0)}K`,
                  color: "text-green-400"
                },
                {
                  label: "Client Revenue",
                  value: c.revenue > 0 ? `₹${(c.revenue / 1e3).toFixed(0)}K` : "–",
                ...
                "div",
                {
                  ...
                  style: { background: "rgba(255,255,255,0.04)" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-[14px] font-bold ${s.color}`, children: s.value }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-komo-text-muted", children: s.label })
                  ]
                },
                s.label
              )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[12px] font-semibold text-purple-300 mb-3 flex items-center gap-1.5", children: [
            ...
            [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] font-semibold text-foreground", children: tier.tier }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-komo-text-muted", children: tier.budget })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] font-bold text-green-400", children: tier.price })
                ]
              },
              tier.tier
            ))
