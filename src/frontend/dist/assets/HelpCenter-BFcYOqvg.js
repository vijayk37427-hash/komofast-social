import { r as reactExports, O as useControllableState, j as jsxRuntimeExports, Q as Primitive, W as useId, Y as composeEventHandlers, _ as Presence, $ as createContextScope, a0 as useComposedRefs, a1 as useLayoutEffect2, a2 as React, a3 as createCollection, a4 as useDirection, v as cn, a5 as ChevronDown, u as useApp, m as motion, o as Search, I as Input, B as Button, b as ue } from "./index-BlWpIyR8.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-5 space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              style: {
                background: "linear-gradient(135deg, rgba(239,68,68,0.08), rgba(168,85,247,0.12))",
                border: "1px solid rgba(239,68,68,0.25)"
              },
              onClick: () => navigate("/complaints"),
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0",
                    style: {
                      background: "linear-gradient(135deg, rgba(239,68,68,0.2), rgba(168,85,247,0.25))"
                    },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { size: 22, className: "text-red-400" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] font-bold text-white", children: "File a Formal Complaint" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-white/50 mt-0.5 leading-snug", children: "For serious violations, harassment, or legal complaints. Processed under IT Act 2000." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 18, className: "text-white/35 flex-shrink-0" })
              ] })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
